...
import logindesign.factory.ViewAbstract;
import logindesign.factory.CustomerView;
import logindesign.factory.AdminView;
...
//        jLabel_Create_Account.setBorder(label_create_accont_border);
        ...
        userNameJLable.setBorder(label_icons_border);
        passwordJLable.setBorder(label_icons_border);
        
        // create border for the username and password field
        Border field_border = BorderFactory.createMatteBorder(1, 5, 1, 1, Color.white);
        userNameTextField.setBorder(field_border);
        passwordTextField.setBorder(field_border);
        
        Border ragister_label_border = BorderFactory.createMatteBorder(0, 0, 1, 0, Color.lightGray);
        registerJLabel.setBorder(ragister_label_border);
    }
    ...
    private void initComponents() {
        ...
        registerJLabel.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        registerJLabel.setForeground(new java.awt.Color(255, 0, 0));
        registerJLabel.setText("Register?");
        registerJLabel.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        registerJLabel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                registerJLabelMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                registerJLabelMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                registerJLabelMouseExited(evt);
            }
        });
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        ...
        try {
            // use the proxy for authenticationg user login
            ...
            if(authProx.authenticate(username, password)){      // USername and password does exist
                // close login form
                this.dispose();
                //reference to the abstract dialog class
                ViewAbstract viewAbstract;
                if(rs.next()){
                    if("admin".equals(rs.getString("type"))){
                        viewAbstract = new AdminView();
                    } else{
                        viewAbstract = new CustomerView();
                    }
                }
                

            }else{      //Username or password or both doesnt exist
                JOptionPane.showMessageDialog(null, "Invlaid Username / Password", "Login Error!", 2);
            }
    ...
    private void registerJLabelMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_registerJLabelMouseEntered
        Border ragister_label_border = BorderFactory.createMatteBorder(0, 0, 1, 0, Color.red);
        registerJLabel.setBorder(ragister_label_border);
    }//GEN-LAST:event_registerJLabelMouseEntered

    private void registerJLabelMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_registerJLabelMouseExited
        Border ragister_label_border = BorderFactory.createMatteBorder(0, 0, 1, 0, Color.lightGray);
        registerJLabel.setBorder(ragister_label_border);
    }//GEN-LAST:event_registerJLabelMouseExited

    private void registerJLabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_registerJLabelMouseClicked
        RegisterJForm registerForm = new RegisterJForm();
